...
//
//  Created by Oğuz Kaan Altun on 10.11.2023.
//
...
final class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    private func getReceivedResult(file: StaticString = #filePath, line: UInt = #line) -> Swift.Result<[FeedImage], Error>? {
